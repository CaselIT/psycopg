...
class IntNumericBinaryDumper(IntNumericDumper):
    ...
    def dump(self, obj: int) -> Buffer:
        return int_to_numeric_dump(obj)
...
class DecimalBinaryDumper(Dumper):
    ...
    def dump(self, obj: Decimal) -> Buffer:
        return decimal_to_numeric_dump(obj)
...
def decimal_to_numeric_dump(obj: Decimal) -> Union[bytearray, bytes]:
...
def int_to_numeric_dump(obj: int) -> bytearray:
